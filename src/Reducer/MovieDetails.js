...
export const MoviesDetails=createAsyncThunk(
    ...
    async(id)=>{
        console.log("move",id)
        let url1=`https://api.themoviedb.org/3/movie/${id}?api_key=4e44d9029b1270a757cddc766a1bcb63&language=en-US`
...
export const MoviesReview=createAsyncThunk( 
    "MoviesReview",
    async(id)=>{
        let url2=`https://api.themoviedb.org/3/movie/${id}/reviews?api_key=4e44d9029b1270a757cddc766a1bcb63&language=en-US&page=1`
